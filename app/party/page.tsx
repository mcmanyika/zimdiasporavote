...
const partyFooterSocialLinks = [
  { label: 'X (Platform Updates)', href: 'https://x.com/DiasporaVote' },
  { label: 'Facebook (Community)', href: 'https://www.facebook.com/share/1C4G3L4eka/' },
  { label: 'YouTube (Live & Briefings)', href: 'https://youtube.com/@DiasporaVote' },
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
          ...
          <div className="border-b border-white/20">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 text-[11px] font-semibold uppercase tracking-wide text-blue-100 sm:px-6">
              ...
              <div className="flex items-center gap-3">
                <a href="https://x.com/DiasporaVote" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white" aria-label="X">
                  <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                <a href="https://www.facebook.com/share/1C4G3L4eka/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white" aria-label="Facebook">
                  <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="https://youtube.com/@DiasporaVote" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white" aria-label="YouTube">
                  <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                  </svg>
                </a>
                <a href="https://whatsapp.com/channel/0029VbCeX3FATRSwXmceVg3z" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white" aria-label="WhatsApp">
                  <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-white py-10 sm:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <p className="mt-2 text-center text-sm text-slate-600">Diaspora Vote Founding Leadership</p>
        </div>
      </section>
