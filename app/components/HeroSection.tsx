  ...
  return (
    ...
    >
      ...
      <div className={`fixed left-2 sm:left-4 top-1/2 z-30 -translate-y-1/2 flex flex-col gap-3 sm:gap-4 bg-black/30 backdrop-blur-sm rounded-full py-3 sm:py-4 px-1.5 sm:px-2 transition-opacity duration-300 ${heroInView ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        <a href="https://x.com/DiasporaVote" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="X (Twitter)">
        ...
        <a href="https://youtube.com/@DiasporaVote" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#FF0000] transition-colors" aria-label="YouTube">
          <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="currentColor" viewBox="0 0 24 24">
