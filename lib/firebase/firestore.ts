...
import {
  ...
  deletePartyEvent as deletePartyEventModule,
  getPartyEvents as getPartyEventsModule,
  getPartyInterestSubmissions as getPartyInterestSubmissionsModule,
  getPartyLandingContent as getPartyLandingContentModule,
  updatePartyEvent as updatePartyEventModule,
  updatePartyInterestSubmission as updatePartyInterestSubmissionModule,
  upsertPartyLandingContent as upsertPartyLandingContentModule,
} from '@/features/party'
...
export const getPartyLandingContent = getPartyLandingContentModule
export const upsertPartyLandingContent = upsertPartyLandingContentModule
export const getPartyEvents = getPartyEventsModule
export const createPartyEvent = createPartyEventModule
export const updatePartyEvent = updatePartyEventModule
export const deletePartyEvent = deletePartyEventModule
export const createPartyInterestSubmission = createPartyInterestSubmissionModule
export const getPartyInterestSubmissions = getPartyInterestSubmissionsModule
export const updatePartyInterestSubmission = updatePartyInterestSubmissionModule
